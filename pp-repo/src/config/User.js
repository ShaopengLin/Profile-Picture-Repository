...
class User {
  #userProps = {
    ...
    imageLink: [],
    profileLink:
      "https://firebasestorage.googleapis.com/v0/b/profilepicrepo.appspot.com/o/default-user-icon-4.jpg?alt=media&token=a1a0114e-08a4-4771-8448-fc4440e418f5",
  };
  /**
    ...
    return fire
      ...
      .then(() => {
        if (fire.auth().currentUser != null) {
          fire
            .storage()
            .ref(fire.auth().currentUser.uid + "/dog.png")
            .put("https://picsum.photos/id/237/200/300");
